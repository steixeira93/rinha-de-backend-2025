...
# Script para testar localmente usando imagem publicada
...
echo "Usando imagem publicada: steixeira93/rinha-2025-go:latest"
echo ""
...
docker compose -f docker-compose.processors.yml down -v 2>/dev/null
cd ../..

# Pull da imagem mais recente
echo "Baixando imagem mais recente..."
docker pull steixeira93/rinha-2025-go:latest

# Não criar rede manualmente - deixar o docker-compose gerenciar
